/*
 * Copyright (c) 2019, Ayran Olckers. All rights reserved.
...
int main( int argc, char** argv )
{
	...
	float* imgCPU    = 0;		// CPU pointer to floating-point RGBA image data
	float* imgCUDA   = 0;		// GPU pointer to floating-point RGBA image data
